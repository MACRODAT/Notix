...
var NavMenuNoLogin = /** @class */ (function (_super) {
    __extends(NavMenuNoLogin, _super);
    function NavMenuNoLogin() {
    ...
    NavMenuNoLogin.prototype.componentWillMount = function () {
        this.toggleNavbar.bind(this);
        this.setState({ redirect: '' });
        this.setState({ collapsed: true });
    };
    NavMenuNoLogin.prototype.render = function () {
        var _this = this;
        return (react_1.default.createElement(reactstrap_1.Navbar, { color: "dark", light: true, expand: "md" },
            ...
            react_1.default.createElement(reactstrap_1.Collapse, { className: "", isOpen: !this.state.collapsed, navbar: true },
                react_1.default.createElement(reactstrap_1.Nav, { className: "mr-auto darkTheme", navbar: true },
                    react_1.default.createElement(reactstrap_1.NavItem, null,
                        react_1.default.createElement(reactstrap_1.NavLink, { className: "darkTheme noDrag", style: __assign({}, exports.noWrap), onClick: function () {
                                _this.toggleNavbar();
                                _this.props.redirecter("/login");
                            } }, "SIGN IN")),
                    react_1.default.createElement(reactstrap_1.NavItem, null,
                        react_1.default.createElement(reactstrap_1.NavLink, { className: "darkTheme noDrag", style: __assign({}, exports.noWrap), onClick: function () {
                                _this.toggleNavbar();
                                _this.props.redirecter("/register");
                            } }, "REGISTER")),
                    react_1.default.createElement(reactstrap_1.NavItem, null,
                        react_1.default.createElement(reactstrap_1.NavLink, { className: "darkTheme noDrag", onClick: function () {
                                _this.toggleNavbar();
                                _this.props.redirecter("/about");
                            } }, "ABOUT")),
                    react_1.default.createElement(reactstrap_1.NavItem, null,
                        react_1.default.createElement(reactstrap_1.NavLink, { className: "darkTheme noDrag", onClick: function () {
                                _this.toggleNavbar();
                                _this.props.redirecter("/todo");
                            } }, "TODOs"))),
    ...
    return NavMenuNoLogin;
}(react_1.Component));
exports.default = NavMenuNoLogin;
